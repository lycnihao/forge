...
import net.koodar.forge.admin.application.vo.RoleVo;
...
public class RoleAppServiceImpl implements RoleAppService {
	...
	public Response addRole(RoleParamDTO roleParamDTO) {
		...
		// 保存角色和权限信息
		List<Permission> permissions = permissionService.listByName(roleParamDTO.getPermissions());
	...
	public Response updateRole(RoleParamDTO roleParamDTO) {
		...
		// 保存角色和权限信息
		List<Permission> newPermissions = permissionService.listByName(roleParamDTO.getPermissions());
